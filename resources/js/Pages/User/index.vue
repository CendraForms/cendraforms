<template>
    ...
    <div class="cf-section mt-5">
        <div class="flex items-center justify-center mb-5 leading-none">
            <button @click="newUser" class="flex items-center p-3 text-base uppercase bg-stone-600 rounded hover:opacity-90 leading-none">
                ...
                <tbody>
                    <tr v-for="user in users" :key="user.id" class="bg-stone-500 border-solid rounded text-center">
                        ...
                        <td class="p-2 border text-black border-black flex flex-row gap-1">
                            <button @click="editUser(user.id)" class="flex items-center p-2 text-base text-indigo-100 bg-indigo-700 hover:opacity-90 rounded leading-none">
                            ...
                            <button @click="deleteUser(user.id, user.name)" class="flex items-center p-2 text-base text-red-100 bg-red-700 hover:opacity-90 rounded leading-none">
